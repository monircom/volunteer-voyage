  ...
  async function run() {
   ...
   app.delete('/post/:id', async (req, res) => {
    ...
    app.post('/applied', async (req, res) => {
        ...
        const volunteerNo =parseInt(appliedData.no_of_volunteers_needed)
        if (volunteerNo == 0 ) {
          return res
            .status(400)
            .send('No Volunteered Need this post.')
        }
       ...
       // Get all jobs data from db for filter
